    ...
    void findById(){
        ...
        StepVerifier.create(moviesInfoMono)
                .assertNext(movieInfo -> {
                    assertEquals("The Dark Knight Rises", movieInfo.getName());
                }).verifyComplete();
    }

    @Test
    void saveMovieInfo(){
        var moviesInfoMono = movieInfoRepository.save(new MovieInfo(null, "Batman Begins", 2005, List.of("Christian Bale", "Micheal Cane"), LocalDate.parse("2005-06-15")));
